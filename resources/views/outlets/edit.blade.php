...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        @else
        <div class="card">
            <div class="card-header">Ubah Informasi </div>
            <form method="POST" action="{{ route('outlets.update', $outlet) }}" accept-charset="UTF-8">
                {{ csrf_field() }} {{ method_field('patch') }}
                <div class="card-body">
                    <div class="form-group">
                        <label for="name" class="control-label">{{ __('Nama Restoran') }}</label>
                    ...
                    <div class="form-group">
                        <label for="address" class="control-label">{{ __('Alamat / Ancer - ancer') }}</label>
                ...
                <div class="card-footer">
                    <input type="submit" value="{{ __('Perbarui Data') }}" class="btn btn-success float-right">
                    <a href="{{ route('outlets.show', $outlet) }}" class="btn btn-primary">{{ __('app.cancel') }}</a>
